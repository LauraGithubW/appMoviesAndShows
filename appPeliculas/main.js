...
async function getList(){
   ...
   const $main=d.getElementById("main"),
    ...
    let res=await  fetch(`https://api.themoviedb.org/4/list/1?page=${page}&api_key=a4e65b6f99641fe9c6618d74e26d0b8a`),
    json=await res.json();
   ...
   //De esta manera conseguimos un scroll infinito
    ...
    //Añadimos el contenido a la sección 
      ...
      <img src="https://image.tmdb.org/t/p/original${movies.poster_path}" alt="${movies.title}" id="movie-poster">
      <h3 id="movie-title" ><b>Título</b>: ${movies.title}</h3>
      <figcaption id="movie-figcaption"><b>Descripción: </b>${movies.overview}</figcaption>
     ...
     //Creamos un mensaje personalizado de error     
        ...
        let message=err.statusText || "Ocurrió un error inesperado al cargar las películas";
